package magicgis.hrm.service.impl;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import magicgis.hrm.dao.DeptDao;
import magicgis.hrm.dao.DocumentDao;
import magicgis.hrm.dao.EmployeeDao;
import magicgis.hrm.dao.JobDao;
import magicgis.hrm.dao.NoticeDao;
import magicgis.hrm.dao.UserDao;
import magicgis.hrm.domain.Dept;
import magicgis.hrm.domain.Document;
import magicgis.hrm.domain.Employee;
import magicgis.hrm.domain.Job;
import magicgis.hrm.domain.Notice;
import magicgis.hrm.domain.User;
import magicgis.hrm.service.HrmService;
import magicgis.hrm.util.tag.PageModel;
